...
Ask the user for (or pull from `brain/grants/opportunities/`):
...
### Step 3: Pull the user's Business Context
...
- Key team bios (the user, Liz, any partners)

If missing data, ASK the user before drafting — don't invent numbers.
...
### Step 5: Flag What Needs the user's Input
...
End with:
- Path to draft
- Top 3 things the user must do before submission
- Deadline countdown
- "Yeeee Hawww! 🤠 Draft is ready, the user. Review, fill in your specifics, and let's go get this money!"
