...
1. **Topic/Theme:** What is the content about? (e.g., a specific deal, a product launch, your signature framework, personal brand)
...
- `brain/knowledge-base/brand/02-brand-voice-and-philosophy.md`
- `brain/knowledge-base/brand/04-content-style-guide.md`
...
After the content is drafted and approved, offer: "Want me to publish these? → `/linda-post-walkthrough` (📣 Holler walks you through posting step by step, or auto-schedules via Postiz if you've got it connected)."
