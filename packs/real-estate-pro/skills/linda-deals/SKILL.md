...
version: 1.0.0
---
> 🤠 **For wholesale + fix-and-flip MAO using Boss's locked Sauce Underwriter formula → use `linda-trigger` instead.** This skill (`linda-deals`) handles other deal types (creative finance, multifamily, MHP/RV park).
