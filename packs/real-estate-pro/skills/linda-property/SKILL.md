...
Save to:
```
~/Desktop/lindaai/output/linda-property/{address-slug}-{date}.md
```
...
- **If the output directory does not exist:** Create `~/Desktop/lindaai/output/linda-property/` automatically before saving.
