...
- User triggers the `/linda-negotiate` command
...
Compile everything into the output format below and save to `brain/research/linda-negotiate-{counterparty-slug}-{YYYY-MM-DD}.md`.
...
**User:** "/linda-negotiate Marcus Williams — he's our CPA and wants to raise his annual retainer from $8K to $12K. I think $9.5K is fair. I'll walk at $10.5K."
...
5. Saves to `brain/research/linda-negotiate-marcus-williams-2026-03-03.md`
